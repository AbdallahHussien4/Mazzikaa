...
# #def segmentImage(binary, sl):
#     # segments = []
#     # linesPos = []
#     # linesPosFreq = [np.zeros(60, dtype=np.uint8)]
#     # for col in range(int(binary.shape[1] / 4), int(3 * binary.shape[1] / 4), 2):
#     #     linesPosTemp = []
#     #     index = 0
#     #     curPos = 0
...
# clefPaths = ["clefsHW/clefHW.jpg"]
# quarterPaths = ["NotesHW/quarterHW.JPG"]
# halfPaths = ["NotesHW/halfHW.JPG"]
# wholePaths = ["Notes/whole.JPG"]
# dotPaths = ["NotesHW/dotHW.JPG"]
# twoDotsPaths = ["NotesHW/dotsHW.JPG"]
# sharpPaths = ["AccidentalsHW/sharpHW.JPG", "AccidentalsHW/sharpHW2.JPG"]
# flatPaths = ["AccidentalsHW/flatHW.JPG"]
# doubleSharpPaths = ["Accidentals/doublesharp.JPG"]
# flagPaths = ["FlagsHW/flagHW.JPG"]
# doubleFlagPaths = ["FlagsHW/doubleflagHW.JPG"]
# tripleFlagPaths = ["FlagsHW/tripleflagHW.JPG"]
...
# def matchNotesHW(binary, sl, ws, linesPositions):
